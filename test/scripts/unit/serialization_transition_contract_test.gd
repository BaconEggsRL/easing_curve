...
const LEGACY_PRE_FLAT_PATH := "res://test/presets/native/contracts/legacy_pre_flat_triangle.tres"
const LEGACY_MISSING_FORCE_PATH := "res://test/presets/native/contracts/legacy_flat_without_force_linear.tres"
