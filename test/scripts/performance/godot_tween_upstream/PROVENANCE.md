...
| project.godot.reference | project.godot | E942995C87024BFDC22C5FD9B599D4C8E4B653D2AB05F23787F74C16B197AFB7 |
...
`project.godot.reference` are reference material for the timing equations and settings;
...
The reference project's filename avoids Godot's nested-project import warning;
its contents and hash are unchanged.
