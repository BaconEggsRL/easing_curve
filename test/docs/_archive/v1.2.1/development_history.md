# Historical development records through 2026-09-10

This preserves the previous testing guide and dated implementation evidence.
Commands, counts, paths, and outstanding issues below describe their original
baselines. Use the [current guide](../../README.md) and
[v1.2.1 tracker](../../v1.2.1_CODE_TRACKER.md) for current instructions and status.
