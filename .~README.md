...
* **Spring** -- Configurable spring easing

Some modes also have additional tunable function parameters not found in Godot's Tween system.
Parameters include:
* **Back**: overshoot
* **Elastic**: amplitude, period
* **Bounce**: num_bounces, bounce_damping
* **Spring**: frequency, decay
...
* **Constant** -- Returns a configurable constant value
* **Physics Spring** -- Configurable spring easing using physics parameters
* **Jitter** -- Noisy linear interpolation with configurable randomness
* **Irregular** -- Stepwise linear interpolation with randomized points
* **Step** -- Configurable stepwise easing
* **Power** -- Configurable fractional power easing

#### CSS Easing Functions

CSS easing functions can also be used directly:

* **Cubic Bézier** -- Define a CSS-style `cubic-bezier()` easing curve
* **Linear** -- Define a CSS-style `linear()` easing function with custom stops
